...
func (s *Service) Migrate() error {
	return s.Service.Migrate(
		...
		internalpostgresmodel.CreateGetUserIDByResetPasswordTokenProc,
		...
		internalpostgresmodel.CreateDeleteUserNoteVersionsByNoteIDProc,
		internalpostgresmodel.CreateDeleteUserNoteTagsByNoteIDProc,
		internalpostgresmodel.CreateDeleteUserNoteProc,
		internalpostgresmodel.CreateDeleteUserNotesByUserIDProc,
		internalpostgresmodel.CreateDeleteUserTagsByUserIDProc,
