...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_router_api_v1_auth.GenerateTOTPUrlResponseBody"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_router_api_v1_auth.VerifyTOTPRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_router_api_v1_auth.VerifyTOTPResponseBody"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "internal_router_api_v1_auth.GenerateTOTPUrlResponseBody": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/internal_router_api_v1_auth.GenerateTOTPUrlResponseData"
                },
                "status": {
                    "type": "string"
                }
        ...
        "internal_router_api_v1_auth.GenerateTOTPUrlResponseData": {
            "type": "object",
            "properties": {
                "totp_url": {
                    "type": "string"
        ...
        "internal_router_api_v1_auth.VerifyTOTPRequest": {
            "type": "object",
            "properties": {
                "totp_code": {
                    "type": "string"
        ...
        "internal_router_api_v1_auth.VerifyTOTPResponseBody": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/internal_router_api_v1_auth.VerifyTOTPResponseData"
                },
                "status": {
                    "type": "string"
                }
        ...
        "internal_router_api_v1_auth.VerifyTOTPResponseData": {
            "type": "object",
            "properties": {
                "recovery_codes": {
                    "type": "array",
